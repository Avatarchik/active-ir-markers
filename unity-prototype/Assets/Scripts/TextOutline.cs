...
using System.Collections;
 ...
 public class TextOutline : MonoBehaviour {
     ...
     private GameObject _leftEyeAnchor = null;
 
     void Start() {
         _leftEyeAnchor = GameObject.Find("LeftEyeAnchor");
     ...
     void LateUpdate() {
         Vector3 screenPoint = _leftEyeAnchor.GetComponent<Camera>().WorldToScreenPoint(transform.position);
         ...
         for (int i = 0; i < transform.childCount; i++) {
             ...
             Vector3 worldPoint = _leftEyeAnchor.GetComponent<Camera>().ScreenToWorldPoint(screenPoint + pixelOffset);
