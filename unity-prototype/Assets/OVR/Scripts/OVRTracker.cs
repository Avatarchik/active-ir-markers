...
public class OVRTracker
{
	...
	public bool isPresent
	{
	    get {
			...
			return (OVRManager.capiHmd.GetTrackingState(0d).StatusFlags & (uint)StatusBits.PositionConnected) != 0;
#else
			return false;
#endif
		}
	...
	public bool isPositionTracked
	{
		get {
#if !UNITY_ANDROID || UNITY_EDITOR
			return (OVRManager.capiHmd.GetTrackingState(0d).StatusFlags & (uint)StatusBits.PositionTracked) != 0;
#else
			return false;
#endif
		}
